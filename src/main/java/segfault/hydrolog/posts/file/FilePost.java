...
abstract class FilePost implements IPost {
    @Nonnull
    public static FilePost create(long id, @Nonnull CharSequence title, long created, long modified, @Nonnull String path, @Nonnull String descr, @Nonnull String author,
                                  @Nonnull File file) {
